...
<body id="page-top">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1">
    					<a class="nav-link py-3 px-0 px-lg-3 rounded" href="Requests">Requests</a>
					</li>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To ADMIN Portal</h1>
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0"><%=session.getAttribute("name") %></p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead"> we believe our people are our greatest asset.
					This space is designed to provide employees with seamless access to 
					important resources, tools, and information that support both personal 
					and professional growth.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Our mission is to foster a work environment that 
					encourages collaboration, innovation, and continuous learning. Here,
					you can explore company updates, manage your tasks, access training programs,
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						2215 Hi-Tech city Bhubaneswar <br /> Clark, MO 65243
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; BHARAT: UserAccessManagement 2024</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
